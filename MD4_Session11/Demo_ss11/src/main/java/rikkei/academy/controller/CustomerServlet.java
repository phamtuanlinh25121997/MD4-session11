...
public class CustomerServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        customerService.save(new Customer(1,"Nguyen Van A","a@gmail.com","Nghe An"));
        customerService.save(new Customer(2,"Nguyen van B","b@gmail.com","Ha Noi"));
        customerService.save(new Customer(3,"Nguyen van C","c@gmail.com","Lai Chau"));
    }
